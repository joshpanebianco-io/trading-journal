// Dashboard stat aggregation, ported verbatim from the old Express server
// (server/routes/stats.js). Takes the full list of the signed-in user's trades
// (ascending by bought_timestamp) plus the active filters and returns the same
// shape the Dashboard already consumes: { summary, equityCurve, byDay, bySession, byDate }.
...
export function computeStats(allTrades, { from, to, symbol, direction, setup, session, timezone } = {}) {
